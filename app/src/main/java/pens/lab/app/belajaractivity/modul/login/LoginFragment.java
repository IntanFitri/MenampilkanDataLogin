...
//        Intent secondIntent = new Intent(LoginFragment.this, ProfileActivity.class);
//        secondIntent.putExtra( etEmail.getText().toString());
//        secondIntent.putExtra( etPassword.getText().toString());
